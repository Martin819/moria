...
public class CategoryScorerTest {
    ...
    public void init() {
        ...
        testRulesetsList.add(TestUtils.createTestRuleset(1, "Mortgage monthly payments", 128, "CSOB", "OUTGOING", "MORTGAGE", null, null, null, null, null, null, null, null, null, null, null, null, null));
        ...
        testRulesetsList.add(TestUtils.createTestRuleset(3, "My main income", 11, null, "INCOMING", "PAYMENT_HOME", new BigDecimal(15000.00), new BigDecimal(25000.00), "00000865", "654651579612", "0600", null, null, null, null, null, null, null, null));
        ...
        testTransactionsList.add(TestUtils.createTestTransaction("2", 6666, transactionValue2, new TransactionPartyAccount("00000865", "654651579612", "0600"), "McDonalds", "INCOMING", "PAYMENT_HOME", TestUtils.parseDate(8, 30, 0), TestUtils.parseDate(8, 30, 0), "Muj zamestanavatel", null, null, null, null, null, null, null, null, null));

        // vydaj - splatka hypoteky
        TransactionValue transactionValue6 = TestUtils.createTransactionValue(new BigDecimal(4099), "czk");
        testTransactionsList.add(TestUtils.createTestTransaction("6", 6666, transactionValue6, new TransactionPartyAccount("00000001", "785845484688", "1500"), "Hypotecni banka", "OUTGOING", "MORTGAGE", TestUtils.parseDate(8, 30, 0), TestUtils.parseDate(8, 30, 0), "Splatka hypoteky", null, null, null, null, null, null, null, null, null));

        // prijem - kamos splatil dluh
        TransactionValue transactionValue12 = TestUtils.createTransactionValue(new BigDecimal(262), "czk");
        testTransactionsList.add(TestUtils.createTestTransaction("12", 6666, transactionValue12, new TransactionPartyAccount("00000000", "191816107239", "0800"), null, "INCOMING", "PAYMENT_HOME", TestUtils.parseDate(8, 30, 0), TestUtils.parseDate(8, 30, 0), "amigo", null, null, null, null, null, null, null, null, null));

        // vydaj - vyber z bankomatu
        TransactionValue transactionValue16 = TestUtils.createTransactionValue(new BigDecimal(5000), "czk");
        testTransactionsList.add(TestUtils.createTestTransaction("16", 6666, transactionValue16, new TransactionPartyAccount(), "CSOB", "OUTGOING", "CASH", TestUtils.parseDate(8, 30, 0), TestUtils.parseDate(8, 30, 0), "vyber z bankomatu", null, null, null, null, null, null, null, null, null));


        categoryScorer = new CategoryScorer(testRulesetsList);
    }
    ...
    public void testProperCategorization() {
        ...
        int categoryID_0 = categoryScorer.scorePossibleCategories(testTransactionsList.get(0));
        Assert.assertEquals(124, categoryID_0);

        // rulesety z import.sql
        int categoryID_1 = categoryScorer.scorePossibleCategories(testTransactionsList.get(1));
        Assert.assertEquals(11, categoryID_1);

        int categoryID_2 = categoryScorer.scorePossibleCategories(testTransactionsList.get(2));
        Assert.assertEquals(128, categoryID_2);

        int categoryID_3 = categoryScorer.scorePossibleCategories(testTransactionsList.get(3));
        Assert.assertEquals(17, categoryID_3);

        int categoryID_4 = categoryScorer.scorePossibleCategories(testTransactionsList.get(4));
