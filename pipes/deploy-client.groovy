...
node {
   ...
   stage('Deploy') {
       sshPublisher(publishers: [sshPublisherDesc(configName: 'moria-cloud-3', transfers: [sshTransfer(cleanRemote: false, excludes: '', execCommand: 'npm start', execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+', remoteDirectory: 'server', remoteDirectorySDF: false, removePrefix: '', sourceFiles: 'target/*.tar.gz')], usePromotionTimestamp: false, useWorkspaceInPromotion: false, verbose: true)])
   }
}